    ...
    <Page title="Cartlann Care, LLC">
      <Card className={"h-full w-full my-9 bg-green1 md:flex"}>
        ...
        <div className="flex flex-col justify-start items-start gap-6">
          <h2 className="w-full text-stone-950 text-4xl 2xl:text-3xl xl:text-2xl lg:text-xl md:text-xl font-bold font-mundial">
            {"Provider Tablet Application Demo"}
          </h2>
          <p className="text-stone-900 font-mundial text-xs md:text-sm lg:text-base 2xl:text-xl">
            <p>
        ...
        <div className="h-fit sm:h-60 flex flex-col">
          ...
          <Card className={"bg-green1 flex-1"}>
            <div className="flex flex-col lg:h-full lg:items-center lg:flex-row gap-6">
              <img className="h-12 w-44" src="/App-Store.svg" />
              <img className="h-12 w-44" src="/Google-Play.svg" />
            </div>
          </Card>
        </div>
        <div className="h-fit md:h-60 lg:44 flex flex-col col-span-full">
          ...
          >
            ...
            {/* <div className="w-full px-1 flex flex-col items-center justify-center">
              <img
                src="/ant-design_cloud-upload-outlined.svg"
                className=""
              />
